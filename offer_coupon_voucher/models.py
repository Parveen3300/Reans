...
# import core models
from grenades_services.modules.vouchers.voucher_decorators import deprecated

# Create your models here.


class Offer(AbstractCreatedByUpdatedBy,
            AbstractDate,
    ...
    # voucher and offer types to use for voucher
    offer_price_type = models.CharField(max_length=128, default='PERCENTAGE', choices=(
        ("PERCENTAGE", "PERCENTAGE"),
        ("RUPPPEES", "INR"),))
    offer_type = models.CharField(
        max_length=128,
        default='offer', choices=(("offer", "Offer"),
                                  ("Voucher", "Voucher")))

    value = models.PositiveIntegerField()
    description = models.TextField(null=True, blank=True)
    included_products = models.ManyToManyField(
        Product, related_name='includes')
...
class VoucherSetConfiguration(models.Model):
    ...
    class Meta:
        ...
        verbose_name = _("Voucher Set Configuration")
        verbose_name_plural = _("Voucher Set Configurations")
...
class Voucher(models.Model):
    ...
    code = models.CharField(
        _("Code"), max_length=128, db_index=True,
        unique=True, help_text=_("Case insensitive / No"
                                 " spaces allowed")
    )
    offers = models.ManyToManyField(
        Offer, related_name='vouchers',
...
class VoucherApplication(models.Model):
    ...
    voucher = models.ForeignKey(
        Voucher,
        on_delete=models.CASCADE,
        related_name="applications", verbose_name=_("Voucher")
    )
